    ...
    return(
        ...
        <div>
            ...
            <div className="text-about">
                ...
                <br></br>
                 <p> 💻  Adquirí conocimientos y experiencia en esta área por medio del programa Misión TIC 2022 del ministerio de telecomunicaciones en Colombia,
                    el cual fue una especie de Bootcamp donde nos preparaban para ser programadores al tiempo que realizábamos proyectos. Adquirí conocimientos y experiencia en esta área por medio del programa Misión TIC 2022 del ministerio de telecomunicaciones en Colombia,
                    el cual fue una especie de Bootcamp donde nos preparaban para ser programadores al tiempo que realizábamos proyectos. Adquirí conocimientos y experiencia en esta área por medio del programa Misión TIC 2022 del ministerio de telecomunicaciones en Colombia,
                    el cual fue una especie de Bootcamp donde nos preparaban para ser programadores al tiempo que realizábamos proyectos. Adquirí conocimientos y experiencia en esta área por medio del programa Misión TIC 2022 del ministerio de telecomunicaciones en Colombia,
                    el cual fue una especie de Bootcamp donde nos preparaban para ser programadores al tiempo que realizábamos proyectos
                </p>
